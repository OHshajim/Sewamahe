...
export function MonetizationPopup({ open, onClose, refetch, info, setShowModal, setRefetch,websiteInfo }: MonetizationPopupProps) {
    ...
    const handleWithdrawSubmit = async (e) => {
        ...
        console.log(amount, paymentMethod, info);
        ...
        const sendingData = paymentMethod === "upi"
            ? {
        ...
        try {
            const { data } = await API.post(
                `${configuration.url}/api/balance/withdrawal-request/${user._id}`,
                sendingData
            );
