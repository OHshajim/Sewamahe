...
export default function TopUp({ setRefetch, refetch, rechargeAmount, paymentMethod }) {
    ...
    const paymentWithRazor = async (e) => {
        ...
        const options = {
            ...
            prefill: {
                ...
                name:`${user?.firstName ?? ""} ${" "} ${user?.lastName ?? ""}`.trim() || "Sawamahe Pro User", // your customer's name
